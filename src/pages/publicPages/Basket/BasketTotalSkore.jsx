  ...
  return (
    <div className=" border border-solid border-gray-200 rounded-lg   py-3 px-7 h-[290px]">
      <h1 className="flex items-center">
        ...
        <p className=" font-semibold text-md text-blue-200 ml-7 ">29 780 000</p>
        <span className=" font-bold text-base text-black ml-1">cyм</span>
      </h1>
      <h2 className="flex   font-bold text-base text-gray-100 my-7">
