...
function Homebannerleft() {
  return (
    <div className=" container col-span-3  ">
      ...
      <div className=" rounded-xl gap-16 max-w-full flex justify-between items-center px-12  bg-[url('/src/assets/images/slider_1.png')] bg-no-repeat bg-center bg-cover mt-8">
        <div className="">
